public class PayrollSystemTest {
    public static void main(String[] args) {
        SalariedEmployee salariedEmployee = new SalariedEmployee("Nguyen", "Huu","111-11-1111", 800.000);
        HourlyEmployee hourlyEmployee = new HourlyEmployee("nguyen","huu","222-22-2222", 16.75,40);
        CommissionEmployee commissionEmployee = new CommissionEmployee("Nguyen", "Duc", "333-33-3333", 100000, .06);
        BasePlusCommissionEmployee basePlusCommissionEmployee = new BasePlusCommissionEmployee("Nguyen", "Toan", "444-44-4444", 5000, .04, 300);
